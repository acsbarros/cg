...
def main():
    ...
    # Criar janela
    window = glfw.create_window(800, 600, "OpenGL Moderno - UNILAB (Apenas Vértices e Arestas)", None, None)
    if not window:
        glfw.terminate()
    ...
    # Aumentar o tamanho dos pontos para os vértices
    glPointSize(8.0)
    ...
    while not glfw.window_should_close(window):
        ...
        # Desenhar as arestas (linhas conectando os vértices)
        glBindVertexArray(VAO)
        glDrawArrays(GL_LINE_LOOP, 0, 3)  # GL_LINE_LOOP desenha o perímetro
        
        # Desenhar os vértices como pontos
        glDrawArrays(GL_POINTS, 0, 3)     # GL_POINTS desenha os vértices individualmente
