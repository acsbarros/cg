...
def load_texture_from_file(image_path):
    ...
    ARGUMENTO:
    image_path - Caminho para o arquivo de imagem (ex: "minha_imagem.jpg", "textura.png")
    
    FORMATOS SUPORTADOS: JPG, PNG, BMP, GIF, etc.
    """
    try:
        ...
        # Inverter verticalmente (OpenGL espera origem no canto inferior esquerdo)
        ...
        # Gerar mipmaps para melhor qualidade em diferentes distâncias
...
def print_controls():
    ...
    print("\n" + "="*60)
    print("CÂMERA EM PRIMEIRA PESSOA - CUBO COM TEXTURA PERSONALIZADA")
    print("="*60)
    ...
    print("  ESC      - Sair")
    print("\nTEXTURA:")
    print("  Sua própria imagem é aplicada em todas as 6 faces do cubo!")
    print("\nOBJETIVO:")
...
def main():
    ...
    # Exemplos:
    #   imagem_path = "foto.jpg"  (arquivo na mesma pasta)
    #   imagem_path = "C:/Users/usuario/Desktop/textura.png"
    #   imagem_path = "../imagens/minha_textura.jpg"
    ...
    # Criar janela
    window = glfw.create_window(800, 600, "Cubo com Textura Personalizada - Câmera em Primeira Pessoa", None, None)
    if not window:
        glfw.terminate()
    ...
    if not texture:
        print("\nNão foi possível carregar a textura. Verifique o caminho da imagem.")
        print(f"Caminho configurado: {IMAGEM_PATH}")
        glfw.terminate()
        sys.exit(1)
